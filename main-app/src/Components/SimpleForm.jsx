          ...
          <ChatBot
            steps={[
              ...
              },
              {
               ...
               // options: this.props.prods,
                  options: [
                      ...
                      { value: "travelInsurance", label: "Travel Insurance", trigger: "14" },
                      { value: "healthInsurance", label: "Health Insurance", trigger: "10" },
                      { value: "homeInsurance", label: "Home Insurance", trigger: "18" },
                  ],
              },
                ...
                trigger: "carNo",
              },
                        {
                            ...
                            validator: (value) => {
                                ...
                                }  else if (/^[A-Z]{2}[ -][0-9]{1,2}(?: [A-Z])?(?: [A-Z]*)? [0-9]{4}$/.test(value)!=true) {
                  ...
                  { value: "tata", label: "Tata", trigger: "20" },
                        ...
                        },
                        {
                            ...
                            validator: (value) => {
                                ...
                                } else if (/^[a-zA-Z]+(?:[\s-][a-zA-Z]+)*$/.test(value) != true) {
                        ...
                        },
                        {
                            ...
                            validator: (value) => {
                                ...
                                } else if (/^(?:(?:31(\/|-|\.)(?:0?[13578]|1[02]))\1|(?:(?:29|30)(\/|-|\.)(?:0?[13-9]|1[0-2])\2))(?:(?:1[6-9]|[2-9]\d)?\d{2})$|^(?:29(\/|-|\.)0?2\3(?:(?:(?:1[6-9]|[2-9]\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00))))$|^(?:0?[1-9]|1\d|2[0-8])(\/|-|\.)(?:(?:0?[1-9])|(?:1[0-2]))\4(?:(?:1[6-9]|[2-9]\d)?\d{2})$/.test(value) != true) {
                                    return "invalid";
                                }
              ...
              },
              {
                ...
                trigger: "21",
                  validator: (value) => {
                      if (/^(\+\d{1,3}[- ]?)?\d{10}$/.test(value) && !(/0{5,}/.test(value))) {
                          return true;
                      }
                      else {
