        ...
        return (
            <ChatBot
                steps={[
                    {
                        id: '1',
                        message: 'Hello...My name is BroBot .May I know your name?',
                        trigger: 'name',
                    },
                    {
                        id: 'name',
                    ...
                    },
                    {
                        ...
                        options: [
                            ...
                            { value: 'renew policy', label: 'Renew policy', trigger: '5' },
                        ],
                    },
                    {
                        id: '5',
                    ...
                    },
                    {
                        id: 'product',
                        options: [
                            { value: 'health', label: 'Health Insurance', trigger: '7' },
                            { value: 'car', label: 'Car Insurance', trigger: '7' },
                            { value: 'home', label: 'Home Insurance', trigger: '7' },
                        ],
                    },
                    {
                        id: '7',
                    ...
                    },
                    {
                        ...
                        validator: (value) => {
                            ...
                            } else if (/^[A-Z]{2}[ -][0-9]{1,2}(?: [A-Z])?(?: [A-Z]*)? [0-9]{4}$/.test(value)) {
                                return `please fill the valid car no`;
                            }
                    ...
                    },
                    {
                        ...
                        validator: (value) => {
                            ...
                            } else if (/[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,15}$/.test(value)) {
                    ...
                    {
                        id: 'end-message',
                        message: 'Thanks! Your data was submitted successfully! Our contact support will get in touch with you soon',
                        end: true,
                    },
                ]}
            />
